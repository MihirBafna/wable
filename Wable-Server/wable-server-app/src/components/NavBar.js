    ...
    return ( 
      <div>
        <Navbar color = "light" light expand = "md" >
            ...
            <NavbarBrand className="ml-auto" href="https://github.com/MihirBafna/wable" style={{ paddingRight: "2vw" }}><img src={githublogo} className="App-logo" alt="logo"width="30px" /></NavbarBrand>
        </Navbar> 
        </div>
    );
}
